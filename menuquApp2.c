...
struct Rumah kontrakan[100] = {
    {
        ...
        "JL. Tun Abdul Razak 1 blok F2 no. 56",
        "08216798503",
        "Nabilah",
        true,
    },
    {
        ...
        "JL. Tun Abdul Razak 1 blok C3 no 33",
        "081254323457",
        "Gre",
        true,
    },
...
void cekKetersediaan()
{
    ...
    {
        tab(4);
        printf("Mohon Maaf, Semua Rumah Sudah Disewakan.");
        getch();
        system("cls");
        menuUtama();
    }
...
void pilihTipe()
{
    ...
    if (!(tipePilihan > 0 && tipePilihan <= jumlahJenisRumah + 1))
    {
    ...
    if (!kontrakan[tipePilihan - 1].isReady)
    { // kondisi 2 sold out
        printf("Maaf Rumah %s Sudah Sold Out\n", kontrakan[tipePilihan - 1].nama);
        getch();
        system("cls");
        pilihTipe();
    }
...
void struk()
{
    ...
    tampilkanDataPengguna();
    printf("Pilihan Tipe Rumah : %s\n", kontrakan[idTersewa].nama);
    printf("Silahkan Tekan Apapun Untuk Kembali Ke Menu Utama ");
    getch();
    system("cls");
    main();
}
...
void menuTipePilihan(int id)
{
    ...
    printf("====================================================\n");
    tab(4);
    printf("1. Spesifikasi Rumah\n");
    tab(4);
    printf("2. Harga Rumah\n");
    tab(4);
    printf("3. Status Rumah\n");
    tab(4);
    printf("4. Kembali\n");
    tab(4);
    printf("5. Lanjutkan Pembelian\n");
    tab(4);
    printf("====================================================\n");
    tab(4);
    printf("Masukkan Pilihan Anda : ");
...
void lanjutPembelian(int id)
{
    ...
    if (pilihan == 'Y')
    {
        if (!kontrakan[id].isReady)
        {
            ...
            tab(4);
            printf("Silahkan Pilih Tipe Yang Lain\n");
            getch();
            system("cls");
            pilihTipe();
        }
...
void daftar()
{
    system("cls");
    printf("========================================================================================================================\n\n\n\n\n");
    printf("====================Daftar Rumah Kontrakqu====================\n");
    for (int i = 0; i < jumlahJenisRumah; i++)
    {
        char status[25] = "Tidak Tersedia";
        if (kontrakan[i].isReady)
            strcpy(status, "Tersedia");
        printf("| %s : %s\n", kontrakan[i].nama, status);
    }
    printf("============================================================\n");
    printf("Kembali? (Silahkan Tekan Apapun)");
    getch();
...
void harga()
{
    ...
    for (int i = 0; i < jumlahJenisRumah; i++)
    {
        printf("\tHarga Sewa Rumah %s :\n", kontrakan[i].nama);
        printf("\tBulanan : Rp. %d\n", kontrakan[i].hargaBulanan);
    }
    printf("=======================================================================\n");
    printf("Kembali? (Silahkan Tekan Apapun)");
    getch();
...
void tentangqu()
{
    ...
    printf("========================================================================================================================\n\n\n\n\n");
    tab(4);
    printf("====================Tentang Hermang Homestay====================\n\n");
    for (int i = 0; i < jumlahJenisRumah; i++)
    {
        tab(4);
        printf("1. %s\n", kontrakan[i].nama);
        ...
        printf("\t- Lokasi = %s \n", kontrakan[i].alamat);
        tab(4);
        printf("\t- Nomor yang dapat anda hubungi : %s (%s)\n\n", kontrakan[i].notelp, kontrakan[i].pemilik);
    }
    tab(4);
    printf("================================================================\n");
    tab(4);
...
void sewaRumah(int id)
{
    ...
    printf("\n");
    tab(4);
    printf("Rumah ini akan di tempati oleh %s\n", namaq);
    tab(4);
    printf("Masukkan Masa Sewa Anda (Bulan) :");
    scanf("%d", &bulan);
    tab(4);
...
void pembayaran(int id, int bulan)
{
    int bayar;
    long nominal;
...
void sudahbayar()
{
    ...
    printf("==================================================\n");
    tab(4);
    printf("Anda sudah melakukan pembelian\n");
    tab(4);
    printf("Apakah ingin kembali ke menu lagi(ya/no)?\n");
    ...
    {
        tab(4);
        printf("Anda akan kembali ke Menu Utama Lagi ");
        getch();
        system("cls");
        main();
    }
    ...
    {
        tab(4);
        printf("Apakah Anda Yakin? (ya/no) : ");
        scanf("%s", bayarrr);
